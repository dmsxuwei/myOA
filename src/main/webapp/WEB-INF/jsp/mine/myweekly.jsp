...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			$.ajax({
		 	...
		 	$.ajax({
	           ...
	           success: function(msg) {	
	        	   ...
	        	   $('#down').attr('href','/oa/report/'+msg.username+'.xls'); 
		...
		dg.datagrid({
			...
			//  {field:'department',title:'所属部门',width:fixWidth(0.05)}
...
<div style="magrin-top: 3px;">
	...
	<div style="display: none">
		<span style="color: #666; magrin-left: 20px">所属部门:</span><input
			id="department_search" name="department_search" value=""
			style="width: 100px"> <span
			style="color: #666; magrin-left: 20px">任务负责人:</span><input
			id="userid_search" name="userid_search" value="" style="width: 100px">
	</div>
	<span style="color: #666; magrin-left: 20px">第几周:</span><input
		id="week_search" name="week_search" value="" style="width: 100px">
	<a id="sertch" href="#" onclick="doSearch()">查询</a> 
	<a id="Export"
		href="#" onclick="doSearch()">导出Excel</a>
</div>
<table id="weeklytb" style="width: 100%; height: 95%"></table>

<a  id="down" href="/oa/report/'+msg.username+'.xls"><span id="download" style="display:none">下一步</span></a>